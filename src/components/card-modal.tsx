                      ...
                      {data.members.slice(0, showAllMembers ? undefined : 6).map((m) => (
                        <div key={m.id} className="relative">
                            ...
                            {activeMemberMenu === m.id && (
                                <div 
                                    ref={memberMenuRef}
                                    className="absolute right-0 top-full mt-2 w-80 bg-background border border-black/10 dark:border-neutral-800 rounded-xl shadow-2xl z-[9999] p-6"
                                >
                                    <div className="flex flex-col items-center mb-4">
                                        <Avatar name={m.name || undefined} email={m.email} image={m.image || undefined} size={150} />
