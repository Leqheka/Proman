...
export default function CreateCard({
  ...
  if (!open) {
    return (
      <button
        className="mt-2 w-full rounded border border-dashed border-black/10 dark:border-white/20 p-2 text-left bg-black/5 dark:bg-black/60 text-foreground hover:bg-black/10 dark:hover:bg-black/70 transition-colors"
