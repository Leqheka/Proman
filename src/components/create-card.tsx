...
export default function CreateCard({
  ...
  if (!open) {
    return (
      <button
        className="mt-2 w-full rounded border border-dashed border-black/10 dark:border-white/20 p-2 text-left bg-background/40 text-foreground hover:bg-background/60 transition-colors"
