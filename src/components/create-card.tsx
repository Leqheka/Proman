...
export default function CreateCard({
  ...
  if (!open) {
    return (
      <button
        className="mt-2 w-full rounded border border-dashed border-black/10 dark:border-white/20 p-2 text-left bg-black/20 text-foreground hover:bg-black/30 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 transition-colors"
