...
export default function AddListTile({
  ...
  if (!open) {
    return (
      <button
        className="w-72 shrink-0 mt-2 rounded-lg border border-dashed border-black/10 dark:border-white/15 p-3 text-left bg-gray-100 hover:bg-gray-200"
  ...
  return (
    <div className="w-72 shrink-0 mt-2 rounded-lg border border-black/10 dark:border-white/15 p-3 bg-gray-100">
