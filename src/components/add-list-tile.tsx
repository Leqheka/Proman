...
export default function AddListTile({
  ...
  if (!open) {
    return (
      <button
        className="w-72 shrink-0 mt-2 rounded-lg border border-dashed border-black/10 dark:border-white/20 p-3 text-left bg-black text-white hover:bg-black/90 transition-colors"
