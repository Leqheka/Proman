...
export default function GlobalSearch() {
  ...
  return (
    <div ref={wrapRef} className="relative flex justify-end">
      {/* Desktop / larger screens: inline long search bar */}
      <div className="hidden sm:block w-full">
        ...
        {visible && (
          <div className="absolute right-0 top-9 w-full max-w-lg max-h-72 overflow-auto rounded border border-black/10 bg-background shadow dark:border-white/15">
            <ul>
              {results.map((r, i) => (
                <li
                  key={`${r.type}:${r.id}`}
      ...
      <div className="sm:hidden">
        ...
        {open && (
          <div className="fixed inset-x-0 top-10 z-50 px-2">
